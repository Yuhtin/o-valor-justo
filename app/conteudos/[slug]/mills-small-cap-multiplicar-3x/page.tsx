...
export default function ArtigoMills() {
  ...
  const artigo = {
    ...
    autor: "Mateus Gusmão",
    imagem: "/images/mills-small-cap.jpg",
                ...
                <div className="p-6">
                  ...
                  <div className="border-b border-gray-200 pb-4 mb-6">
                    <p className="text-gray-700 text-lg">
                      {artigo.resumo} Este artigo sintetiza a tese de investimento com base em análises recentes das
                      duas gestoras, e uma análise própria. Destacando <strong>portfólio privilegiado</strong>,{" "}
                  ...
                  <div className="prose max-w-none">
                    ...
                    <figure className="my-6">
                      <img
                        src="/revenue-diversification-construction-decrease.png"
                    ...
                    <figure className="my-6">
                      <img
                        src="/addressable-market-brazil.png"
                    ...
                    <figure className="my-6">
                      <img
                        src="/placeholder.svg?height=300&width=600&query=JM Empilhadeiras acquisition highlights with 4.3x EV/EBITDA multiple"
                    ...
                    <figure className="my-6">
                      <img
                        src="/placeholder.svg?height=300&width=600&query=DCF valuation model showing 19% annual return"
