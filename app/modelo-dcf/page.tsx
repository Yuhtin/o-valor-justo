...
import { projetarDividendos, formatarNumero } from "@/lib/calculators/tir-utils"
import { calcularTIRDosFluxos } from "@/lib/calculators/tir-utils"
import {
...
export default function ModeloDCF() {
  ...
  const calcular = () => {
    ...
    const valorEmpresaCalculado = calcularValorEmpresa(
      fclAtualNum,
      taxaCrescimentoNum,
      taxaCrescimentoPerpetuaNum,
      taxaDescontoNum,
    )
    setValorEmpresa(valorEmpresaCalculado)

    // Cálculo do valor justo por ação
    const valorJustoCalculado = valorEmpresaCalculado / acoesEmCirculacaoNum
    ...
    // Calcular a TIR usando o algoritmo corrigido
    console.log("Fluxos enviados para cálculo da TIR:", fluxos)
    const tirCalculada = calcularTIRDosFluxos(fluxos)
    console.log("Resultado da TIR:", tirCalculada)
    setTir(tirCalculada)

    // Gerar matriz de sensibilidade
    const calculaValorJustoFn = (taxaCrescimento: number, taxaDesconto: number) => {
      const valorEmpresa = calcularValorEmpresa(fclAtualNum, taxaCrescimento, taxaCrescimentoPerpetuaNum, taxaDesconto)
      return valorEmpresa / acoesEmCirculacaoNum
    }
  ...
  // Função para calcular o valor da empresa
  ...
  const dadosGrafico = fluxosCaixa.map((valor, index) => ({
    ano: index === 0 ? "Ano 0" : `Ano ${index}`,
    valor: valor,
  }))
  ...
  return (
    <>
      <Head>
        <title>Calculadora de DCF | Fluxo de Caixa Descontado para Valuation de Empresas</title>
        <meta
          name="description"
          content="Avalie empresas pelo método do fluxo de caixa descontado com projeções de 10 anos. Ferramenta profissional para análise fundamentalista de ações."
        />
        <meta
          name="keywords"
          content="modelo DCF, fluxo de caixa descontado, valuation de empresas, análise fundamentalista, projeção financeira"
        />
        <link rel="canonical" href="https://valorjusto.com.br/modelo-dcf" />
        <meta property="og:title" content="Calculadora de DCF | Fluxo de Caixa Descontado para Valuation de Empresas" />
        <meta
          property="og:description"
          content="Avalie empresas pelo método do fluxo de caixa descontado com projeções de 10 anos."
        />
        <meta property="og:url" content="https://valorjusto.com.br/modelo-dcf" />
      ...
      <div className="min-h-screen bg-[#f5f9f7]">
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <h1 className="text-xl font-bold mb-2">Modelo DCF</h1>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="tooltip ml-2">
                      ...
                      <span className="tooltip-text">
                        Fluxo de Caixa Livre atual em milhões de reais (você pode encontrar esses dados no Status
                        Invest, Investidor10 ou nas Demonstrações financeiras da empresa)
                      </span>
                    </div>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="tooltip ml-2">
                      <InfoIcon className="h-4 w-4 text-gray-400" />
                      <span className="tooltip-text">Taxa de crescimento anual esperada para o FCL</span>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                {!calculado ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <h4 className="text-sm font-medium mb-2">Fluxos de Caixa Projetados</h4>
                        ...
                        {detalhesAbertos && (
                          <div className="mt-3 overflow-x-auto">
                            <table className="w-full text-xs border-collapse">
                              ...
                              <tbody>
                                {fluxosCaixa.map((fluxo, index) => (
                                  <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : ""}>
                                    <td className="border border-gray-200 p-1">
                                      {index === 0 ? "Ano 0" : `Ano ${index}`}
                                    </td>
                                    <td className="border border-gray-200 p-1 text-right font-medium">
                                      {formatarNumero(fluxo, 2)}
                                    </td>
                                    <td className="border border-gray-200 p-1">
                                      {index === 0
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        A TIR calculada é uma projeção baseada em premissas definidas pelo usuário e não representa
                        garantia de retorno.
                      </p>
                    </div>
